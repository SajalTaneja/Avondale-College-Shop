...
namespace Avondale_College_Shop.Areas.Identity.Data
{
    ...
    {        public static async Task Initialize(AvondaleDbContext context,
        ...
        internal static object Initialize(UserManager<IdentityUser> userMgr, RoleManager<IdentityRole> roleMgr)
        {
